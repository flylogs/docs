---
description: Elevated pilot accounts with crew oversight and flight management capabilities
---
...
| Capability | Flight Instructor | Chief Pilot |
|---|:---:|:---:|
| View own flights | ✅ | ✅ |
...
| Edit / create schedule records | Company setting | ✅ |
| Send schedule notifications | Own only | ✅ All |
| View pilot duty times | Own | All pilots |
| Pilot audit page | — | ✅ |
| FI assignment management | Own only | ✅ All |
| Access billing | — | — |
| Manage user accounts | — | — |

***

## Assigning these account types
...
For more on creating pilot accounts, see [Create Pilots or Students](create-pilots-or-students.md).
For a full overview of all account types across the system, see [Account types](../company-management/account-types.md).
